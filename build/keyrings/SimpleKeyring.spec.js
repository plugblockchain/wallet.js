...
var _SimpleKeyring = require("./SimpleKeyring");
...
describe('SimpleKeyring', () => {
  ...
  it('recover keyring', async () => {
    ...
    const kr = new _SimpleKeyring.SimpleKeyring([json]);
  ...
  describe('import account', () => {
    ...
    beforeEach(() => {
      keyring = new _SimpleKeyring.SimpleKeyring();
    });
    describe('from json', () => {
    ...
    it('from seed', async () => {
      const pair = keyring.addFromSeed((0, _util.hexToU8a)(TEST_ACCOUNT_SEED.seed));
      expect(pair.isLocked).toEqual(false);
